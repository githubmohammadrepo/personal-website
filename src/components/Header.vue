<template>
    <div class="vh-one">
            <header class="">
                <div class="header-img bg-info"></div>

                <!-- navbar -->
                <nav class="navbar navbar-inverse flex-row-reverse bg-inverse navbar-expand-md  navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse  rtl" id="navbarSupportedContent">
                        <ul class="navbar-nav pr-2 ml-auto">
